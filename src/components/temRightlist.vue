...
<template>
  <div class="rightlistBox">
    <section>
      <div class="r1-head">
        <img :src="'../../static/img/headbg02.jpg'" alt="">
        <h1>
          <span>King</span>Bowen
        </h1>
      </div>
      <div class="r1-body">
        <p>你能抓到我么？</p>
