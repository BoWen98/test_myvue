<template>
  <div class="footBack footBackQian">
    <div class="footer-img" :style="backgroundDiv">
    </div>
    <div class="fcontainer">
      ...
      <p>
        <span>Made with</span> <img class="fheart" src="../../static/img/heart02.png"/> <span>by Bowen.</span>
      </p>
    </div>
  </div>
</template>
...
<script>
  ...
  export default {
    data() { //选项 / 数据
      return {
        backgroundDiv: {
          backgroundImage: 'url(' + require('../../static/img/footer01.png') + ')',
    ...
    methods: { //事件处理器
      runTime: function () {//运行倒计时
        var that = this;
        var oldTime = new Date('2019/11/25 00:00:00');
